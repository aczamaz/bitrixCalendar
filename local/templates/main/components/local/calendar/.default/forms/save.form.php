<div class="modal fade" id="save-form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="js-save-task" class="btn btn-primary">Save changes</button>
            </div>
        </div>
    </div>
</div>